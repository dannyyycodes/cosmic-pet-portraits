      ...
      {isFinal ? (
          <>
            ...
            <p className="text-lg text-muted-foreground mb-6">
              "Reading this made me fall in love with my cat all over again." — Join pet parents who truly <em>get</em> their companion.
            </p>
            {/* Value Stack */}
        ...
        <div className="flex flex-col items-center gap-4 mb-6">
          <Button variant="cosmic" size="lg" className="text-lg px-8 py-6 group shadow-[0_0_25px_hsl(var(--primary)/0.3)]" asChild>
