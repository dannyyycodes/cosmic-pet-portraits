  ...
  return (
    ...
    >
      ...
      {playlist.map((item, i) => (
        <div
          key={i}
          className="flex items-center gap-2.5 py-2 border-b border-[#e2dbf3] last:border-b-0"
        >
          <span className="text-[0.7rem] font-bold text-[#928aa8] w-5">
          ...
          >
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[0.82rem] font-semibold text-[#2a2440] group-hover:underline decoration-[#1DB954]/40 underline-offset-2">
                {item.title}
              </span>
            </div>
            <div className="text-[0.7rem] text-[#928aa8] ml-5">{item.artist}</div>
          </a>
          <span className="text-[0.62rem] text-[#8b7bd8] font-semibold uppercase tracking-[0.5px]">
            {item.vibe}
          </span>
        </div>
      ))}
