  ...
  return (
    ...
    >
      <a
        ...
        style={{
          background: 'linear-gradient(135deg, #f6f3ff 0%, #f5ede0 100%)',
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <div className="text-[0.78rem] font-semibold text-[#2a2440]">
              {content.text}
            </div>
            <div className="text-[0.68rem] text-[#928aa8]">
              {content.subtext}
            </div>
          </div>
          <span className="text-[#8b7bd8] text-[0.75rem]">→</span>
        </div>
      </a>
    </motion.div>
  );
