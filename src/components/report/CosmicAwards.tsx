  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: 'linear-gradient(165deg, #2a2440 0%, #201a30 60%, #1f1613 100%)',
      ...
      >
        ...
        <div className="text-[0.6rem] font-bold tracking-[2.5px] uppercase text-[#8b7bd8]/80 mb-1 text-center">
            ...
            >
              <div className="relative flex-shrink-0 mt-0.5">
                <div
                  ...
                  style={{
                    background: 'radial-gradient(circle, rgba(139,123,216,0.25) 0%, rgba(139,123,216,0.08) 60%, transparent 100%)',
                    boxShadow: '0 0 12px rgba(139,123,216,0.15)',
                  }}
                >
              ...
              <div>
                <div className="font-dm-serif text-[0.88rem] text-[#8b7bd8]">
                  {award.award}
                </div>
        ...
        <div className="mt-4 pt-3 border-t border-[#8b7bd8]/15 text-center">
          <p className="text-[0.65rem] text-[#8b7bd8]/40 italic">
