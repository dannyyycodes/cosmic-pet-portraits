...
const occasionThemes: Record<OccasionMode, {
  ...
  memorial: {
    cardType: 'KEEPER',
    specialAbility: 'Quiet Presence',
    abilityDescription: 'Remains as a thread in every room they once knew.',
    attackName: 'Held Memory',
    attackDescription: 'Returns warmth to one Benched companion per turn.',
    attackDamage: '—',
    weaknessType: 'None',
    resistanceType: 'All',
