  ...
  return (
    <>
      ...
      >
        ...
        <p className="text-[0.84rem] leading-[1.75] text-[#928aa8] max-w-[400px] mx-auto mt-2">
        ...
        {planets.map((planet) => {
          ...
          return (
            <motion.div
              ...
              variants={s.variants}
              className="flex gap-3 p-3 px-3.5 rounded-xl bg-white border border-[#e2dbf3]"
            >
              <div
              ...
              <div>
                <h5 className="text-[0.8rem] font-bold text-[#2a2440] mb-0.5">{planet.name}</h5>
                <div className="text-[0.65rem] font-semibold text-[#8b7bd8] uppercase tracking-[0.5px] mb-0.5">
                  Governs: {planet.governs}
                </div>
                <p className="text-[0.74rem] text-[#928aa8] leading-[1.5]">{planet.desc}</p>
              </div>
            </motion.div>
          );
        })}
