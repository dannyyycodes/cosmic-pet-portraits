    ...
    <>
      ...
      >
        <div className="flex items-center justify-center gap-3 mb-4">
          <div className="w-10 h-[1px] bg-[#8b7bd8]/30" />
          <span className="text-[#8b7bd8]/50 text-[0.7rem]">✦</span>
          <div className="w-10 h-[1px] bg-[#8b7bd8]/30" />
        </div>
        <p
          className="text-[1.05rem] text-[#928aa8] italic leading-[1.8]"
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(165deg, #2a2440 0%, #201a30 40%, #14101f 100%)',
          boxShadow: '0 8px 40px rgba(42,36,64,0.35)',
      ...
      >
        ...
        <div className="absolute top-0 right-0 w-40 h-40 rounded-full pointer-events-none opacity-15"
          style={{ background: 'radial-gradient(circle, rgba(139,123,216,0.4), transparent 70%)' }} />
        ...
        <div className="relative z-10 px-7 py-10 sm:px-9">
          {/* Opening quote */}
          <div className="text-[3.5rem] leading-none text-[#8b7bd8]/25 font-serif mb-2">&ldquo;</div>
          ...
          {/* Closing quote */}
          <div className="text-[3.5rem] leading-none text-[#8b7bd8]/25 font-serif mt-3 text-right">&rdquo;</div>

          {/* Divider */}
          <div className="flex items-center justify-center gap-3 my-5">
            <div className="w-10 h-[1px] bg-[#8b7bd8]/20" />
            <span className="text-[#8b7bd8]/40 text-[0.6rem]">✦</span>
            <div className="w-10 h-[1px] bg-[#8b7bd8]/20" />
          </div>

          {/* Attribution */}
          <div className="text-center">
            <div className="text-[0.9rem] text-[#8b7bd8] font-bold">
