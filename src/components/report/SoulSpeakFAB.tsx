...
export function SoulSpeakFAB({ reportId, petName, shareToken }: SoulSpeakFABProps) {
  ...
  return (
    <a
      ...
      style={{
        background: 'linear-gradient(135deg, #14101f 0%, #2e2218 50%, #2a2440 100%)',
        boxShadow: '0 4px 20px rgba(0,0,0,0.3), 0 0 0 1px rgba(139,123,216,0.2), 0 0 40px rgba(139,123,216,0.08)',
        color: '#fff',
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = '0 6px 28px rgba(0,0,0,0.35), 0 0 0 1px rgba(139,123,216,0.35), 0 0 50px rgba(139,123,216,0.12)';
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.transform = 'scale(1)';
        e.currentTarget.style.boxShadow = '0 4px 20px rgba(0,0,0,0.3), 0 0 0 1px rgba(139,123,216,0.2), 0 0 40px rgba(139,123,216,0.08)';
      }}
    >
      ...
      >
        <span
          ...
          style={{
            background: 'linear-gradient(105deg, transparent 40%, rgba(139,123,216,0.6) 50%, transparent 60%)',
      ...
      <span
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(139,123,216,0.2), rgba(139,123,216,0.08))',
