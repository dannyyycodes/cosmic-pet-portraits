  ...
  return (
    <header
      ...
      style={{
        ...
        borderBottom: scrolled ? `1px solid rgba(176,142,230,0.22)` : "1px solid rgba(157,122,214,0.16)",
        height: 64,
      }}
    >
      <div
        ...
        <div className="flex items-center gap-2 md:gap-3">
          {user ? (
            ...
            <Link
              ...
              style={{
                color: C.cosmosText,
                border: "1px solid rgba(157,122,214,0.28)",
                borderRadius: 8,
                fontFamily: "Lato, system-ui, sans-serif",
              }}
              aria-label="Sign in"
          ...
          <a
            ...
            onMouseEnter={(e) => (e.currentTarget.style.background = "#d8c5f5")}
          ...
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            <SheetTrigger asChild>
              <button
                ...
                style={{
                  width: 40,
                  height: 40,
                  border: "1px solid rgba(157,122,214,0.32)",
                  borderRadius: 8,
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[360px]" style={{ background: C.cosmos, borderColor: "rgba(176,142,230,0.22)" }}>
              <nav className="mt-10 flex flex-col gap-2" aria-label="Mobile primary">
                ...
                <div className="mt-6 flex flex-col gap-2 border-t pt-6" style={{ borderColor: "rgba(176,142,230,0.22)" }}>
                  <SheetClose asChild>
                    <Link
                      to={user ? "/account" : "/auth"}
                      className="mx-4 inline-flex items-center justify-center gap-2 px-4 py-3 text-center"
                      style={{
                        border: "1px solid rgba(176,142,230,0.28)",
                        borderRadius: 8,
                        color: C.cosmosText,
                        fontFamily: "Lato, system-ui, sans-serif",
                        fontSize: 15,
