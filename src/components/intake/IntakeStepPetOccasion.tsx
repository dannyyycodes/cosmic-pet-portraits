  ...
  const occasions = [
    {
      ...
      subtitle: "Find out what makes them tick — their personality secrets, hidden quirks, and why you two just click.",
    ...
    },
    {
      ...
      subtitle: "Make their special day unforgettable with a personalized cosmic portrait and what the stars say about their year ahead.",
    ...
    },
    {
      ...
      subtitle: "Create a beautiful tribute celebrating the love you shared. A keepsake honoring the paw prints they left on your heart.",
