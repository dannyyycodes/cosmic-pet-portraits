...
const slides: Slide[] = [
  ...
  },
  {
    id: 4,
    duration: 12,
    headline: "Pet parents are discovering their pet's hidden soul",
    testimonial: {
...
Pet parents are discovering their pet's hidden soul. Mia said, quote, "My husband was like, did you write this?" end quote.
