...
const ALL_REVIEWS = [
  ...
  { name: "Mike P.", pet: "Rocky, Boxer, 7", text: "Got this for my daughter's dog. She framed the painted portrait and hung it in her apartment. Beautiful.", rating: 5, time: "2 weeks ago" },
  ...
  { name: "Emma L.", pet: "Mochi, Siamese, 5", text: "We framed the painted portrait. It's hanging in our living room. The writing in the keepsake PDF was so personal and warm.", rating: 5, tag: "verified", time: "10 days ago" },
  ...
  { name: "Grace T.", pet: "Olive, Calico, 3", text: "Bought this for my sister's birthday. She called me crying. The painted portrait looked exactly like Olive somehow.", rating: 5, tag: "verified", time: "1 week ago" },
  ...
  { name: "Hannah P.", pet: "Biscuit, Scottish Fold, 2", text: "The painted portrait alone was worth it. Then the personality reading made me realise how much Biscuit means to me. Then SoulSpeak made me cry. 10/10.", rating: 5, time: "1 month ago" },
  ...
  { name: "Sam N.", pet: "Nugget, Guinea Pig, 2", text: "A full soul reading for a guinea pig! And the painted portrait was the cutest thing I've ever seen.", rating: 5, tag: "verified", time: "1 week ago" },
  ...
  { name: "Dave W.", pet: "Gift for girlfriend's dog Benny", text: "Valentine's Day gift. She loved it more than flowers or jewelry. The painted portrait and compatibility chart was the cherry on top.", rating: 5, time: "3 weeks ago" },
  ...
  { name: "Kelly M.", pet: "Gus, Bulldog, 4", text: "The painted portrait looks more like Gus than most photos I've taken of him. It's now my screensaver.", rating: 5, tag: "verified", time: "1 week ago" },
