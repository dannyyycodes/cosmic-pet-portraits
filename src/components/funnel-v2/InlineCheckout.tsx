...
/* ──────── Cosmic payment rail ────────
 * Real card-brand marks straight on the dark cosmic panel — nothing behind
 * the logos. Visa & Apple Pay use their official white (dark-background)
 * mark; Mastercard / Amex / Google / Klarna keep their real colours. Thin
 * gold dividers between; no lockup text (the proof row covers "Secure"). */
...
const PAY_DIV: CSSProperties = { width: 1, height: 16, background: "rgba(212,182,122,0.28)", flexShrink: 0 };
const PAY_WORD: CSSProperties = { color: "#ececf2", fontFamily: "Lato, system-ui, sans-serif", fontSize: 13, fontWeight: 700 };

const CosmicPaymentRail = () => (
  <div className="flex flex-wrap items-center justify-center mt-5" role="list" aria-label="Accepted payment methods">
    ...
    <span style={PAY_MARK} role="img" aria-label="Mastercard">
      <svg viewBox="0 0 32 20" height="20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <circle cx="12" cy="10" r="7" fill="#EB001B" />
        <circle cx="20" cy="10" r="7" fill="#F79E1B" />
    ...
    <span style={{ ...PAY_MARK, gap: 4 }} role="img" aria-label="Apple Pay">
      <svg viewBox="0 0 17 20" height="18" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <span style={PAY_WORD}>Pay</span>
    </span>
    <span style={PAY_DIV} aria-hidden="true" />

    <span style={{ ...PAY_MARK, gap: 4 }} role="img" aria-label="Google Pay">
      <svg viewBox="0 0 24 24" height="18" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <span style={PAY_MARK} role="img" aria-label="Klarna">
      <svg viewBox="0 0 24 24" height="15" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <path fill="#FFB3C7" d="M4.592 2v20H0V2h4.592zm11.46 0c0 4.194-1.583 8.105-4.415 11.068l-.278.283L17.702 22h-5.668l-6.893-9.4 1.779-1.332c2.858-2.14 4.535-5.378 4.637-8.924L11.562 2h4.49zM21.5 17a2.5 2.5 0 110 5 2.5 2.5 0 010-5z" />
      </svg>
    </span>
  </div>
);
