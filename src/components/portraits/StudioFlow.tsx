...
import { CanvasConfigurator } from "@/components/portraits/CanvasConfigurator";
...
export function StudioFlow({ onCartAdd, onPhaseChange }: StudioFlowProps) {
   ...
   *  generate/configure another pawtrait. The cart itself persists in the
   *  parent; this just resets the studio's working state. */
        ...
        <AnimatePresence>
          {!generating && variants.length > 0 && approved && (
            <motion.div
              ...
              className="mt-10"
            >
              {/* Configurator — photo → size → canvas → checkout (rebuilt 2026-06-01) */}
              <CanvasConfigurator
                ...
                canAdd={canAdd}
                onAdd={handleAdd}
                preparing={preparingPrintMaster}
                preparingText={printMasterStageText}
                preparingElapsed={printMasterElapsedSec}
