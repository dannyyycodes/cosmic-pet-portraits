...
const REVIEWS: Review[] = [
  ...
  { img: 12, q: "Penny sniffed it for a full minute then reclaimed the rug.", name: "Rachel" },
  ...
  { img: 21, q: "Kiko yawned right at his own travel poster. Iconic.", name: "Anna" },
  ...
  { img: 54, q: "Now there are two of her. The room can barely cope.", name: "Helena" },
