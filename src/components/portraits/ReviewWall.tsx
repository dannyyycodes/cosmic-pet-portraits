...
const REVIEWS: Review[] = [
  ...
  { q: "Wear the tee on dog walks. Three people stopped me already.", name: "Ben", product: "tee" },
  ...
  { q: "Hard to describe. Like, my dog but better.", name: "Patrick", product: "framed canvas" },
  { q: "The cosmic chart one is unreal. Hung it in the bedroom.", name: "Cara", product: "framed canvas" },
  { q: "My cat. As a wizard. Yes.", name: "Joel", product: "framed canvas" },
  ...
  { q: "Got it on a whim and now I want one of every cat I've ever had.", name: "Imogen", product: "framed canvas" },
  ...
  { q: "Renaissance portrait. Of a chihuahua. Sublime.", name: "Naomi", product: "framed canvas" },
