    ...
    <div style={{ minHeight: '100vh', background: C.cream, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '32px 16px', fontFamily: 'Lato, system-ui, sans-serif' }}>
      <div style={{ width: '100%', maxWidth: 440, textAlign: 'center' }}>
        ...
        <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: 'spring', delay: 0.15, stiffness: 180 }}
          ...
          <div style={{ width: 88, height: 88, borderRadius: '50%', background: `linear-gradient(135deg, ${C.gold}, #b89a5a)`, display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 8px 32px rgba(212,182,122,0.25)' }}>
            <Gift style={{ width: 40, height: 40, color: '#141210' }} />
          </div>
        ...
        <AnimatePresence mode="wait">
          {!giftData ? (
            ...
            <motion.div key="enter" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              <div>
                <h1 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 'clamp(1.5rem, 8vw, 2.2rem)', color: C.ink, lineHeight: 1.1, marginBottom: 8 }}>
              ...
              <button onClick={() => validateCode(giftCode)} disabled={!giftCode || isValidating}
                style={{
                  ...
                  color: (!giftCode || isValidating) ? C.muted : '#141210',
                  cursor: (!giftCode || isValidating) ? 'default' : 'pointer',
                  fontFamily: 'Lato, system-ui, sans-serif', fontWeight: 700, fontSize: '1rem',
            ...
            <motion.div key="revealed" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              {giftData.giftMessage && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
                  style={{ padding: 24, background: C.cream2, borderRadius: 20, border: `1px solid ${C.cream3}`, position: 'relative' }}>
                  {/* Decorative quotes */}
              ...
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
                ...
                <div style={{ width: 52, height: 52, borderRadius: '50%', background: C.cream2, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 14px', border: `1px solid ${C.cream3}` }}>
                ...
                <h2 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: '1.5rem', color: C.ink, marginBottom: 6 }}>{getTierName()}</h2>
              ...
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
                style={{ padding: 20, background: C.cream2, borderRadius: 18, border: `1px solid ${C.cream3}`, textAlign: 'left' }}>
              ...
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}
                ...
                <button onClick={handleContinue} style={{
                  ...
                  background: C.rose, color: '#141210', cursor: 'pointer',
                  fontFamily: 'Lato, system-ui, sans-serif', fontWeight: 700, fontSize: '1.05rem',
                  display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
