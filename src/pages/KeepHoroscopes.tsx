    ...
    return (
      <Shell>
        <div style={{ textAlign: "center", padding: "32px 0" }}>
          ...
          <h1 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: "clamp(1.8rem, 6vw, 2.4rem)", color: C.ink, lineHeight: 1.1, marginBottom: 14 }}>
            Their stars keep arriving.
          </h1>
          <p style={{ fontFamily: "Lato, system-ui, sans-serif", fontSize: "1.05rem", color: C.earth, lineHeight: 1.55, marginBottom: 24, maxWidth: 380, margin: "0 auto 24px" }}>
            Your card is on file. Next horoscope drops Sunday. Cancel anytime in two clicks from any horoscope email.
          </p>
          <Link to="/" style={{ display: "inline-block", padding: "12px 28px", background: C.rose, color: "#141210", borderRadius: 50, textDecoration: "none", fontFamily: "Lato, system-ui, sans-serif", fontWeight: 700, letterSpacing: "0.04em" }}>
  ...
  return (
    <Shell>
      <div style={{ textAlign: "center" }}>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "5px 14px", borderRadius: 50, background: "rgba(212,182,122,0.12)", border: `1px solid rgba(212,182,122,0.25)`, marginBottom: 20 }}>
        ...
        <h1 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: "clamp(2rem, 7vw, 2.8rem)", color: C.ink, lineHeight: 1.05, letterSpacing: "-0.02em", marginBottom: 18 }}>
          Keep their cosmic guidance arriving every week.
        </h1>

        <p style={{ fontFamily: "Lato, system-ui, sans-serif", fontStyle: "italic", color: C.earth, fontSize: "clamp(1.05rem, 3.4vw, 1.18rem)", lineHeight: 1.55, marginBottom: 26, maxWidth: 440, margin: "0 auto 26px" }}>
            The free month came with the gift. After that, weekly horoscopes are £4.99/month — billed to your card, not the gifter's.
        </p>

        {status === "cancelled" && (
          <p style={{ fontFamily: "Lato, system-ui, sans-serif", color: C.muted, fontSize: "0.92rem", marginBottom: 18 }}>
            No worries — you can come back anytime before your trial ends.
          </p>
        )}

        {error && (
          <p style={{ fontFamily: "Lato, system-ui, sans-serif", color: "#f0d99f", fontSize: "0.95rem", marginBottom: 18 }}>
            {error}
          </p>
        )}
        ...
        <button
          ...
          style={{
            ...
            boxShadow: "0 4px 24px rgba(212,182,122,0.25)",
            minHeight: 56,
            minWidth: 240,
          }}
        >
        ...
        <p style={{ fontFamily: "Lato, system-ui, sans-serif", color: C.muted, fontSize: "0.84rem", marginTop: 18, lineHeight: 1.5 }}>
        ...
        <ul style={{ listStyle: "none", padding: 0, margin: "32px auto 0", maxWidth: 380, textAlign: "left" }}>
          {[
            ...
            <li key={i} style={{ display: "flex", gap: 10, alignItems: "flex-start", padding: "8px 0", color: C.earth, fontFamily: "Lato, system-ui, sans-serif", fontSize: "0.95rem", lineHeight: 1.5 }}>
...
function Shell({ children }: { children: React.ReactNode }) {
  return (
    <div style={{ minHeight: "100vh", background: C.cream, fontFamily: "Lato, system-ui, sans-serif", padding: "32px 16px 60px" }}>
      <div style={{ maxWidth: 540, margin: "0 auto" }}>
        ...
        <div style={{ background: "rgba(245,239,230,0.05)", border: `1px solid ${C.sand}`, borderRadius: 24, padding: "40px 28px 36px", boxShadow: "0 10px 36px rgba(0,0,0,0.4)" }}>
          {children}
        </div>
      </div>
    </div>
