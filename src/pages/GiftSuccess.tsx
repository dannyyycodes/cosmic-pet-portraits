...
const C = {
  ...
  ink: '#f5efe6', warm: '#cfc1b1', earth: '#cfc1b1', muted: '#9d8d7f',
...
export default function GiftSuccess() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: C.cream, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '32px 16px', fontFamily: 'Lato, system-ui, sans-serif' }}>
      <div style={{ width: '100%', maxWidth: 440, textAlign: 'center' }}>
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} style={{ marginBottom: 28 }}>
          <h1 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: 'clamp(1.6rem, 8vw, 2.4rem)', color: C.ink, lineHeight: 1.1, marginBottom: 8 }}>
        ...
        {isHardcover && (
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
            style={{ padding: 24, background: C.cream2, borderRadius: 20, border: `1px solid ${C.cream3}`, boxShadow: '0 4px 24px rgba(0,0,0,0.4)', marginBottom: 20 }}>
            ...
            {[
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'start', gap: 10, padding: '8px 0', borderBottom: i < 3 ? `1px solid ${C.cream3}` : 'none' }}>
                <span style={{ color: '#d4b67a', fontWeight: 700, fontSize: '0.88rem', flexShrink: 0 }}>{i + 1}.</span>
        ...
        {!isHardcover && <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
          style={{ padding: 28, background: C.cream2, borderRadius: 20, border: `1px solid ${C.cream3}`, boxShadow: '0 4px 24px rgba(0,0,0,0.4)', marginBottom: 20 }}>
          ...
          {isLink ? (
            <>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                <button onClick={copyLink} style={{ padding: '12px 0', borderRadius: 50, border: `1px solid ${C.cream3}`, background: 'transparent', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, fontFamily: 'Lato, system-ui, sans-serif', fontWeight: 600, fontSize: '0.88rem', color: C.ink }}>
                  <Copy style={{ width: 15, height: 15 }} /> Copy Link
                </button>
                <button onClick={share} style={{ padding: '12px 0', borderRadius: 50, border: 'none', background: C.rose, color: '#141210', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, fontFamily: 'Lato, system-ui, sans-serif', fontWeight: 600, fontSize: '0.88rem' }}>
        ...
        {!isHardcover && <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}
          style={{ padding: 20, background: C.cream2, borderRadius: 18, border: `1px solid ${C.cream3}`, textAlign: 'left', marginBottom: 24 }}>
          <p style={{ fontWeight: 700, fontSize: '0.88rem', color: C.ink, marginBottom: 12, display: 'flex', alignItems: 'center', gap: 6 }}>
            <Sparkles style={{ width: 14, height: 14, color: C.gold }} /> What happens next
          </p>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6 }} style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          <Link to="/gift" style={{ textDecoration: 'none' }}>
            <button style={{ width: '100%', padding: '14px 0', borderRadius: 50, background: C.rose, color: '#141210', border: 'none', cursor: 'pointer', fontFamily: 'Lato, system-ui, sans-serif', fontWeight: 700, fontSize: '0.95rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
              <Gift style={{ width: 18, height: 18 }} /> Gift Another Person
            </button>
          </Link>
          <Link to="/" style={{ textDecoration: 'none' }}>
            <button style={{ width: '100%', padding: '12px 0', borderRadius: 50, background: 'transparent', border: `1px solid ${C.cream3}`, color: C.muted, cursor: 'pointer', fontFamily: 'Lato, system-ui, sans-serif', fontWeight: 600, fontSize: '0.88rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
